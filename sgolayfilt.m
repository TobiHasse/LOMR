...
% 2023 TRH edit: call sgolay_octave on line 54, revert if possible
...
%   $Revision: 1.10 $  $Date: 2001/04/02 20:20:56 $
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% %
% calling the private function sgolay_octave.m for use without Signal  %
% Processing Toolbox.  Revert to sgolay(____) if toolbox is available  %
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% %

B = sgolay_octave(k,F,W); % TRH edit Octave does not support Weights
