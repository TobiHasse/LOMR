% 2023, edited by Tobias Hasse tobiack@udel.edu to match MATLAB syntax
...
function F = sgolay_octave(p, n, m, ts)
    m = 0;
    ts = 1;
  ...
  elseif p >= n
    ...
    if length(m) > 1, error("weight vector unimplemented"); end %if
